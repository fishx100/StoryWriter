...
rem Backend: use explicit Python executable to avoid environment issues
start "StoryWriter Backend" powershell -NoExit -Command "Set-Location 'd:\Projects\StoryWriter\backend'; & 'C:\Users\dance\miniconda3\python.exe' -m uvicorn app.main:app --reload --port 8000"
